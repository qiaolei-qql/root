...
#define list_item_destory(item_ptr) do{     \
    if(NULL != item_ptr) {                  \
          mem_free(item_ptr);               \
    }                                       \
}while(0) 
...
#define queue_head_name(listname)           \
    list_head_name(listname)

#define queue_item_name(listname)           \
    list_item_name(listname)

#define queue_head_ptr(listname)            \
    list_head_ptr(listname)

#define queue_item_ptr(listname)            \
    list_item_ptr(listname)

#define queue_next_ptr(listname)            \
    list_next_ptr(listname)

#define queue_def(listname)                 \
    list_def(listname)

#define queue_new(listname, head_ptr)       \
    list_new(listname, head_ptr)

#define queue_item_new(listname, item_ptr)  \
    list_item_new(listname, item_ptr)

#define queue_item_destroy(item_ptr)        \
    list_item_destory(item_ptr)

#define queue_lock(head_ptr)                \
    list_lock(head_ptr)

#define queue_unlock(head_ptr)              \
    list_unlock(head_ptr)

#define queue_empty(head_ptr)               \
    list_empty(head_ptr)

#define queue_size(head_ptr)                \
    list_size(head_ptr)

#define queue_front(head_ptr)               \
    list_first(head_ptr)

#define queue_back(head_ptr)                \
    list_last(head_ptr)

#define queue_push(head_ptr, item_ptr)      \
    list_push(head_ptr, item_ptr)
    
#define queue_pop(head_ptr, item_ptr)       \
    list_shift(head_ptr, item_ptr)

#define queue_destroy(item_ptr)             \
    list_destroy(item_ptr)
