...
function! s:ProjectUpdate()
    ...
    " create tags file
    if executable('ctags')
        call system("find ./src -name '*.h' -o -name '*.c' -o -name '*.cpp'  | grep -v thirdparty >  "  . proj_data . "/tag.files ")
        echo "find ./src -name '*.h' -o -name '*.c' -o -name '*.cpp'  | grep -v thirdparty >  "  . proj_data . "/tag.files "
